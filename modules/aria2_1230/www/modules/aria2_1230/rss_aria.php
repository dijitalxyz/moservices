...
function rss_aria_content()
{
	include( 'modules/core/rss_view_list.php' );

	class rssAriaView extends rssSkinListView
	{
		const itemHeight = 80;
...
?>
	...
	{
	        url = "<?= getMosUrl().'?page=rss_aria_menu' ?>";
	}
	else
...
<?php
	...
	$view = new rssAriaView;

	$view->topTitle = 'Aria2c';
