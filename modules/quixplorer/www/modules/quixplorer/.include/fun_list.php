...
//		$new_file_size = get_abs_file_size($abs_new_item);
...
function _print_edit_buttons ($dir)
{
	...
	if( $GLOBALS["display_file_upload_icon"] ) _print_link("upload", permissions_grant($dir, NULL, "create") && get_cfg_var("file_uploads"), $dir, NULL);
	_print_link("archive", 
