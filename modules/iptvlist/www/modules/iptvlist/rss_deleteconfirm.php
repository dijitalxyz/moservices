...
function rss_deleteconfirm_content()
{
...
<text offsetXPC=2 offsetYPC=20 widthPC=96 heightPC=11.24 align=center fontSize=16 backgroundColor=-1:-1:-1 foregroundColor=255:255:255 >
	<script>
                "<?= getMsg( 'iptvDelChannel' ) ?>";
	</script>
</text>
