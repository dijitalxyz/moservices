...
<item>
	<title><?= getMsg( 'iptvMoveUp' ) ?></title>
	<action>video_frwd</action>
</item>

<item>
	<title><?= getMsg( 'iptvMoveDn' ) ?></title>
	<action>video_ffwd</action>
</item>

<item>
	<title><?= getMsg( 'iptvMoveUpPg' ) ?></title>
	<action>pageup</action>
</item>

<item>
	<title><?= getMsg( 'iptvMoveDnPg' ) ?></title>
	<action>movepagedown</action>
</item>
