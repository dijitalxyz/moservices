...
function rss_addtofavorites_content()
{
...
<text offsetXPC=2 offsetYPC=40 widthPC=96  heightPC=12.1 align=center fontSize=12 backgroundColor=-1:-1:-1 foregroundColor=255:255:255 >
	<script>
        "<?= getMsg( 'iptvAddFav' ) ?>";
	</script>
</text>
...
<channel>
	...
	<link><?= getMosUrl().'?page=' ?>rss_addtofavorites</link>
