...
class rssYifyView extends rssSkinHTile
{
	const itemWidth		= 193;
	const itemHeight	= 259;
...
?>
    <text offsetXPC="<?= $px ?>" offsetYPC="<?= $py ?>" widthPC="<?= $pw ?>" heightPC="<?= $ph ?>"
     redraw="yes" align="left" lines="3" fontSize="14"
     backgroundColor="<?= static::itemUnFocusBgColor ?>"
...
?>
	...
	{
	        url = "<?= getMosUrl().'?page=rss_yify_menu' ?>";
...
?>
  ...
  <onEnter>
	moUrl = "<?= getMosUrl().'?page=yify_list' ?>";
	savedItem = 0;
