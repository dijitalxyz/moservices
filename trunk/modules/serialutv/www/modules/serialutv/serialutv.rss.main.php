...
class rssSerialutvView extends rssSkinHTile
{
	const itemWidth		= 234;
	...
	const itemFocusBgColor   = '250:179:84';
	const itemUnFocusBgColor = '46:17:24';
	const itemBackgroundColor = '46:17:24';
	const backgroundColor = '46:17:24';
	const imageUnFocus	= 'serialutv/serialu_bg.jpg';
	const background	= 'serialutv/serialu_bg.jpg';
	const topBackground = 'serialutv/serialu_left.jpg';
	const bottomBackground = 'serialutv/serialu_left.jpg';
	const imageFocus	= 'serialutv/serialu_focus.png';
	//
	// ------------------------------------
	public $topTitle =
'
...
?>
	...
	else if (userInput == "<?= getRssCommand('video_ffwd') ?>")
	{
			...
			url = "<?= getMosUrl().'?page=serialutv_izb' ?>" + "&amp;id=" + izb;
			doModalRss( url );
	...
	else if (userInput == "<?= getRssCommand('play') ?>" || userInput == "<?= getRssCommand('enter') ?>")
	{
		...
		url = "<?= getMosUrl().'?page=rss_serialutv_info' ?>" + "&amp;url=" + id;
		doModalRss( url );
		cancelIdle();
		ret = "true";
	}
	...
	{
	        url = "<?= getMosUrl().'?page=rss_serialutv_menu' ?>";
...
?>
  ...
  <onEnter>
	moUrl = "<?= getMosUrl().'?page=serialutv_list' ?>";
	savedItem = 0;
