...
function rss_norecording_content()
{
...
<text offsetXPC=2 offsetYPC=20 widthPC=96 heightPC=11.24 align=center fontSize=14 backgroundColor=-1:-1:-1 foregroundColor=255:255:255 >
	<script>
                "<?= getMsg( 'iptvRec' ) ?>";
	</script>
</text>
...
<text offsetXPC=2 offsetYPC=37 widthPC=96  heightPC=12.1 align=center fontSize=12 backgroundColor=-1:-1:-1 foregroundColor=255:255:255 >
	<script>
        "<?= getMsg( 'iptvYouPlaying' ) ?>";
	</script>
</text>
...
<itemDisplay>
<text offsetXPC=0 offsetYPC=0 widthPC=100 heightPC=0 useBackgroundSurface="yes"/>
...
<channel>
	...
	<link><?= getMosUrl().'?page=' ?>rss_norecording</link>
