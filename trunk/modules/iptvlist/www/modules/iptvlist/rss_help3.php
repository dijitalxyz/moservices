...
<channel>
	...
	<link><?= getMosUrl().'?page=' ?>rss_help3</link>
...
<item>
    <title><?= getMsg( 'iptvSelPrevNextVid' ) ?></title>
...
<item>
	<title><?= getMsg( 'iptvShowHideOSDVid' ) ?></title>
